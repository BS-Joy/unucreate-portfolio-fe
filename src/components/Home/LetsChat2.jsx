    ...
    return (
        <div className='mx-auto max-w-[1298px]  mb-[78px]  relative px-0  lg:px-10 xl:px-0'>
            <motion.h1
                ...
                className='uppercase text-olive font-anton text-[80px] md:text-[90px] lg:text-[128px] leading-[200px] mb-[21px]'>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center gap-[10px] lg:gap-[177px] relative'>
                ...
                <div className='text-[#EE3322FE] text-[13px] font-abel leading-snug absolute left-0'>
