    ...
    return (
        <div className='mx-auto max-w-[1298px]  mb-[78px]  relative px-0  lg:px-10 xl:px-0'>
            <motion.h1
                ...
                className='uppercase text-olive font-anton text-[40px] md:text-[90px] lg:text-[128px]  mb-[21px] text-center'>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-center gap-[10px] lg:gap-[177px] relative'>
                <motion.div
                    ...
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 1, delay: 0.5 }}
                    className='uppercase text-olive font-anton text-[80px] md:text-[90px] lg:text-[128px] max-w-[640px] leading-[200px] z-10'>
                    <Image
                        src={manImg}
                        width={1000}
                        height={1000}
                ...
                <div className='text-[#EE3322FE] text-xs md:text-[13px] font-abel leading-1 md:leading-snug absolute left-0 top-1 md:top-[20%] text-center md:text-left -z-10'>
