...
const ShowroomMobile = () => {
    return (
        <div className=''>
            ...
            /> */}
            <div
                className="w-[375px] h-[379px] bg-cover bg-center flex flex-col items-center justify-center"
                style={{ backgroundImage: `url(${showroom1.src})` }} // Set the sky image as background
            >
                <motion.div
