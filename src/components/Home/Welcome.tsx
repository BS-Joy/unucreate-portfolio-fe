...
const Welcome = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-0 lg:gap-[109.69px] my-0 lg:my-[123px]  lg:pt-0  lg:mt-0  md:space-y-0">
      ...
      >
        ...
        <div className="relative mb-[20px] md:mb-[70px] px-[68px] lg:px-0">
          ...
          <div className="bg-primary w-[270px] sm:w-[300px] md:w-[350px] lg:w-[509px] h-[67.65px] md:h-[90px] lg:h-[192px] rounded-none lg:rounded-[20px] flex items-center justify-center absolute top-[80%] left-[50%] transform -translate-x-1/2 -translate-y-1/2">
            ...
            <h1 className="text-olive font-anton text-[32px] md:text-[55px] uppercase tracking-widest">
              Welcome
            </h1>
          </div>
        </div>
        ...
        <div className="px-[20px] block lg:hidden">
          ...
          <div className="float-none pt-2">
            <h1 className="text-[#202020] font-abel text-[14px] md:mb-0 text-left tracking-[.15em] leading-[32px] uppercase max-w-[10px]">
              Hi, I'm Jodi. I'm a storyteller, innovation consultant, creative
              strategist, and UX designer who fuses creativity with strategic
              insight to transform ideas into immersive digital and physical
              experiences that challenge the ordinary, spark curiosity, and
              create lasting impact. Rooted in user-centered design and
              research, I blend data{" "}
              <span className="text-secondary font-semibold">
                insights, play
              </span>
              , and{" "}
              <span className="text-secondary font-semibold">innovation</span>{" "}
              to craft interactions that inspire, connect, and reimagine the
              human experience.
            </h1>
          </div>
        </div>
        ...
        <div className="hidden lg:block">
          <h1 className="text-[#202020] font-abel text-[20px]  mb-[27px] text-center tracking-widest leading-[40px] uppercase max-w-[487px]">
            Hi, I'm Jodi. storyteller, innovation Consulant, creative
            strategist, and UX designer who fuses creativity with strategic
            insight to transform ideas into immersive digital and physical
            experiences. I aim to challenge the ordinary, spark curiosity, and
            create meaningful impact. Rooted in user-centered design and
            research, I blend data insights, play, and innovation to craft
            interactions that inspire, connect, and reimagine how people engage
        ...
        <div className="hidden lg:block">
          <div className="relative">
            <button
              className={`w-[206px] lg:w-[228px] h-[48px] lg:h-[80px] bg-secondary rounded-[40px] flex items-center justify-center uppercase font-anton text-[#333333] text-[20px] z-10 relative `}
            >
              Let's connect
            </button>
            <button className="w-[206px] lg:w-[228px] h-[48px] lg:h-[80px] bg-primary rounded-[40px] flex items-center justify-center uppercase font-anton text-olive text-[20px] absolute -bottom-2 left-2"></button>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="hidden lg:block">
          <h1 className="text-[#202020] font-abel text-[20px]  mb-[50px] text-center tracking-widest leading-[40px] uppercase">
            I’m Jodi Swaby, an NYC-based User experience designer AnD artist. I
            transform ideas into immersive digital and physical experiences that
            challenge the ordinary and spark curiosity. Rooted in user-centered
            design, I blend Data insights, play, and innovation to craft
            interactions that inspire, connect, and reimagine the human
            experience.
          </h1>
        </div>
      ...
      >
        <Image
          ...
          className="w-[900px] h-[700px] lg:h-[910px] object-contain relative "
        />

        {/* Location mark */}
        <div className="absolute bottom-[215px] sm:bottom-[180px] md:bottom-48 lg:bottom-[220px] xl:bottom-[190px] flex xl:hidden items-center gap-[8px]">
          <RiMapPinLine className="text-[24px]" />
          <h1 className="font-americanTypewritter text-[14px] leading-[32px] tracking-widest uppercase">
            Brooklyn, New York{" "}
          </h1>
        </div>
        ...
        <div className="block lg:hidden -mt-3 lg:-mt-0">
          <div className="relative">
            <button
              className={`w-[206px] lg:w-[260px] h-[48px] lg:h-[80px] bg-secondary rounded-[40px] flex items-center justify-center uppercase font-anton text-[#333333] text-[16px] z-10 relative `}
            >
              Let's connect
            </button>
            <button className="w-[206px] lg:w-[260px] h-[48px] lg:h-[80px] bg-primary rounded-[40px] flex items-center justify-center uppercase font-anton text-olive text-[16px] absolute -bottom-2 left-2"></button>
          </div>
        </div>
      </motion.div>
    </div>
