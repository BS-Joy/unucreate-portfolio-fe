            ...
            <div className='flex flex-col items-center gap-[15px]'>
                <div className='flex items-center gap-[19px] lg:gap-[29px]'>
                    <div className='flex flex-col items-center justify-center gap-[12px] lg:gap-[22px]'>
                        ...
                        <p className='font-abel text-olive text-[13px] lg:text-[20px] max-w-[200px] lg:max-w-[225px] leading-snug text-center'>I drive human-centered design from research to prototyping, ensuring teams solve the right problems.</p>
                    </div>
                ...
                <div className='flex flex-row-reverse items-center gap-[19px] lg:gap-[29px]'>
                    <div className='flex flex-col items-center justify-center gap-[12px] lg:gap-[22px]'>
                        ...
                        <p className='font-abel text-olive text-[13px] lg:text-[20px] max-w-[200px] lg:max-w-[225px] leading-snug text-center'>I create cohesive brand identities and strategies that connect with audiences across digital and physical touchpoints.
                ...
                <div className='flex items-center gap-[19px] lg:gap-[29px]'>
                    <div className='flex flex-col items-center justify-center gap-[12px] lg:gap-[22px]'>
                        ...
                        <p className='font-abel text-olive text-[13px] lg:text-[20px] max-w-[200px] lg:max-w-[225px] leading-snug text-center'>I craft impactful, user-focused experiences through UX, customer experience, and creative strategy
                ...
                <div className='flex flex-row-reverse items-center gap-[19px] lg:gap-[29px]'>
                    <div className='flex flex-col items-center justify-center gap-[12px] lg:gap-[22px]'>
                        ...
                        <p className='font-abel text-olive text-[13px] lg:text-[20px] max-w-[200px] lg:max-w-[225px] leading-snug text-center'>I transform ideas into market-ready ventures using lean principles to deliver measurable results.</p>
                    </div>
