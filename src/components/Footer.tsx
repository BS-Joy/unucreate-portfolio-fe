...
const Footer = () => {
    ...
    return (
        <div className='bg-black h-[530px] '>
            <div className="flex gap-[82px] pt-[29px] border-b border-white pb-[22px]">
                <Image
                    src={logo}
                    width={200}
                    height={200}
                    alt='Jodi Logo Image'
                    className='w-[310px] h-[317px] object-contain  pl-[54px]'
                />
                <div className='space-y-10'>
                    ...
                    {/* Social links */}
                    <div className='flex items-center gap-[15px] pt-[30px] justify-end'>
