...
const DoubleButton = ({ text, bgColor, textColor }: { text: string, bgColor: string, textColor: string }) => {
    return (
        <div className='relative'>
            <button className={`w-[180px] lg:w-[260px] h-[60px] lg:h-[80px] ${bgColor} rounded-[40px] flex items-center justify-center uppercase font-anton ${textColor} text-[20px] z-10 relative font-bold`}>
                {text}
            </button>
